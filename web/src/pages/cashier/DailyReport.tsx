...
export default function DailyReport() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    toast({
      ...
      description: `Daily report for ${format(new Date(), 'MMM dd, yyyy')} submitted successfully`,
    });
        ...
        <Card>
          <CardHeader>
            ...
            <p className="text-sm text-muted-foreground">
              Submit your daily financial report • {format(new Date(), 'EEEE, MMMM dd, yyyy')}
            </p>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                ...
                <div className="space-y-2">
                  <Label htmlFor="cashReceived" className="flex items-center gap-2">
