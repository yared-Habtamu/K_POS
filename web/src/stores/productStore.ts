...
const mockProducts: Product[] = [
  {
    ...
    category: 'Beverages',
    unit: 'pcs',
    pictureUrl: 'https://images.unsplash.com/photo-1629203851122-3726ecdf080e?w=200',
    purchasePrice: 18,
    sellingPrice: 25,
    quantity: 150,
    storeQuantity: 200,
  ...
  },
  {
    ...
    category: 'Beverages',
    unit: 'pcs',
    pictureUrl: 'https://images.unsplash.com/photo-1553456558-aff63285bdd1?w=200',
    purchasePrice: 14,
    sellingPrice: 20,
    quantity: 80,
    storeQuantity: 120,
  ...
  },
  {
    ...
    category: 'Snacks',
    unit: 'pcs',
    pictureUrl: 'https://images.unsplash.com/photo-1566478989037-eec170784d0b?w=200',
    purchasePrice: 35,
    sellingPrice: 50,
    quantity: 45,
    storeQuantity: 60,
  ...
  },
  {
    ...
    category: 'Dairy',
    unit: 'l',
    pictureUrl: 'https://images.unsplash.com/photo-1563636619-e9143da7973b?w=200',
    purchasePrice: 45,
    sellingPrice: 60,
    quantity: 25,
    storeQuantity: 30,
  ...
  },
  {
    ...
    unit: 'pcs',
    pictureUrl: 'https://images.unsplash.com/photo-1549931319-a545dcf3bc73?w=200',
    purchasePrice: 12,
    sellingPrice: 18,
    quantity: 60,
    storeQuantity: 40,
  ...
  },
  {
    ...
    unit: 'pcs',
    pictureUrl: 'https://images.unsplash.com/photo-1592924357228-91a4daadcfea?w=200',
    purchasePrice: 55,
    sellingPrice: 75,
    quantity: 8,
    storeQuantity: 20,
  ...
  },
  {
    ...
    category: 'Household',
    unit: 'pcs',
    pictureUrl: 'https://images.unsplash.com/photo-1585441695325-21557c836c45?w=200',
    purchasePrice: 40,
    sellingPrice: 55,
    quantity: 35,
    storeQuantity: 50,
  ...
  },
  {
    ...
    category: 'Household',
    unit: 'kg',
    pictureUrl: 'https://images.unsplash.com/photo-1550411294-875a03bd3fcc?w=200',
    purchasePrice: 65,
    sellingPrice: 85,
    quantity: 5,
    storeQuantity: 15,
...
export const useProductStore = create<ProductState>((set, get) => ({
  ...
  getLowStockProducts: () => {
    return get().products.filter(p => p.supermarketQuantity <= p.lowStockThreshold);
  },

  getExpiringProducts: (days = 7) => {
    const threshold = new Date();
    threshold.setDate(threshold.getDate() + days);
    return get().products.filter(p => p.expiryDate && new Date(p.expiryDate) <= threshold);
  },
}));
