class NamedRoutes {
  ...
  // static const String UPPER_CATEGORY = "/upper_category_page";
  ...
  static const String RegisterMartPage = "/register_mart";
  static const String RegistrationStatusPage = "/registration_status";
